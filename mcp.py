...
pin16.switch_to_output(value=True)
pin17.switch_to_output(value=True)
pin18.switch_to_output(value=True)
pin19.switch_to_output(value=True)
pin20.switch_to_output(value=True)
pin21.switch_to_output(value=True)
pin22.switch_to_output(value=True)
pin23.switch_to_output(value=True)
pin24.switch_to_output(value=True)
pin25.switch_to_output(value=True)
pin26.switch_to_output(value=True)
pin27.switch_to_output(value=True)
pin28.switch_to_output(value=True)
pin29.switch_to_output(value=True)
pin30.switch_to_output(value=True)
pin31.switch_to_output(value=True)
